...
async function gendoc (config) {
  ...
  for (const rec of newsQ) {
    if (rec.firstBatch) {
      ...
      const obj = Object.assign(rec, {text})
      // console.log('\n\n# %o', obj)
      console.log(fill(`For the signal described as _text a suitable label or name or title is _label`, obj) + '\n\n')
      console.log(fill(`For the signal described as _text the NewsQ field identifier is _id`, obj) + '\n\n')
      console.log(fill(`For the signal described as _text one expected source is _source`, obj) + '\n\n')
      console.log(fill(`For the signal described as _text the NewsQ signal reference number is _index`, obj) + '\n\n')
      if (obj.methodology) console.log(fill(`For the signal described as _text the methodology for measuring the signal is _methodology`, obj) + '\n\n')
    } 
  }
