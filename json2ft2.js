...
async function gendoc (config) {
  ...
  for (const rec of newsQ) {
    if (rec.firstBatch) {
      ...
      const obj = Object.assign(rec, {text, key: 'e' + entityCount++})
      // console.log('\n\n# %o', obj)
      if (!rec.methodology) delete rec.methodology
      ...
      console.log(shred(obj, schema))

      /*
      console.log(fill(`Item _key has the description text _text`, obj) + '\n\n')
      console.log(fill(`Item _key has the name or title _label`, obj) + '\n\n')
      console.log(fill(`Within the NewsQ V1 API, item _key has field identifier is _id`, obj) + '\n\n')
      console.log(fill(`One expected source for the item _key is _source`, obj) + '\n\n')
      console.log(fill(`Within the NewsQ V1 API, item _key has the signal reference number _index`, obj) + '\n\n')
      if (obj.methodology) console.log(fill(`Item _key is gathered with a methodology described like this: _methodology`, obj) + '\n\n')
      */
    } 
  }
